...
//+kubebuilder:rbac:groups=monitoring.httpcheck.io,resources=cronjobs,verbs=get;list;watch;create;update;patch;delete,namespace=webapp
//+kubebuilder:rbac:groups=monitoring.httpcheck.io,resources=cronjobs/status,verbs=get;update;patch,namespace=webapp
//+kubebuilder:rbac:groups=monitoring.httpcheck.io,resources=cronjobs/finalizers,verbs=update,namespace=webapp
